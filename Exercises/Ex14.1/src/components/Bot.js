...
export default React.createClass({
    ...
    render: function () {
        ...
        if (this.state.isAlertVisible) {
            return <Alert bsStyle="warning" onDismiss={this.onDismiss}>Bot is <a href="#" className={'alert-link'} onClick={this.toggleActive}>{this.state.isActive ? " active" : " inactive"}</a></Alert>
        }
        return null;
    }
});