    ...
    render: function () {
        return <div>
            ...
            <form onSubmit={this.onAddReaction}>
                <label>Question: <input value={this.state.question} onChange={this.onQuestionChanged}/></label><br />
                ...
                <label>Image URL: <input value={this.state.imageUrl} onChange={this.onImageUrlChanged}/></label><br />
