    ...
    render(){
        ...
        return(
            ...
            <Col lg="3" sm="6" className="border">
                ...
                <Button color="danger" onClick={this.onRemove}>Remove</Button><br />
                <img alt="" src={imageUrl} />
                <h3>{question}</h3>
                <Button color="primary" onClick={this.incrementAnswer1.bind(this)}
                        disabled={!this.state.isActive}>
                    {answer1} ({ Math.round(100 * this.state.answer1Count / 
                        ( this.state.answer1Count + this.state.answer2Count)) || 0 }%)
                </Button>
                <Button color="primary" onClick={this.incrementAnswer2}
                        disabled={!this.state.isActive}>
