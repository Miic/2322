...
export default React.createClass({
    ...
    render: function () {
        return <div style={{padding: 5, border: "1px black solid", margin: 10, width: 256, float: 'left'}}>
            ...
            <button ref="a1b" onClick={this.incrementAnswer1}>{this.props.answer1} [{this.state.answer1Count}]
                [{Math.round(100 * this.state.answer1Count / ( this.state.answer1Count + this.state.answer2Count))}]%
            </button>
            <button ref="a2b" onClick={this.incrementAnswer2}>{this.props.answer2} [{this.state.answer2Count}]
